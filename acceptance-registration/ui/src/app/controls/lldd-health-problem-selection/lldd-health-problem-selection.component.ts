...
import { LLDDHealthProblemService } from 'src/app/service/lldd-health-problem.service';
...
export class LLDDHealthProblemSelectionComponent
  implements OnInit, ControlValueAccessor
{
  ...
  constructor(
    private service: LLDDHealthProblemService,
